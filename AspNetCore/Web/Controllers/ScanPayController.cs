...
namespace Alipay.Web.Controllers
{
    public class ScanPayController : Controller
    {
        private readonly IAlipayF2FService _alipayF2FService;
        private readonly IHostingEnvironment _hostingEnvironment;
        public ScanPayController(IHostingEnvironment hostingEnvironment, IAlipayF2FService alipayF2FService)
        {
        ...
        public IActionResult ScanCodeGen(string orderName, string orderAmount, string outTradeNo)
        {
            ...
            var bitmap = new Bitmap(Path.Combine(_hostingEnvironment.WebRootPath, "images/alipay.png"));
        ...
        private AlipayTradePrecreateContentBuilder BuildPrecreateContent(string orderName, string orderAmount, string outTradeNo)
        {
            ...
            //收款账号
            builder.seller_id = AppSettingHelper.AlipayUid;
            //订单编号
